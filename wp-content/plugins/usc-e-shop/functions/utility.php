...
function usces_get_delivery_company_url($delivery_company, $tracking_number){
	switch ( $delivery_company ){
		...
		case '日本通運':
			$url = 'http://www.nittsu.co.jp/butsuryu/search/';
			break;
		...
		case '名鉄運輸':
			$url = 'http://ap.meitetsuunyu.co.jp/webtrace/webtsuiseki/webtsuiseki.aspx';
			break;
		...
		case '飛騨倉庫運輸':
			$url = 'http://www.nohhi.co.jp/support/index.html';
			break;
