			...
			<tr>
				<td colspan='5' class='submittd'>
					<div id='skusubmit-<?php echo $id; ?>' class='submit'>
						...
						<input name='updateitemsku[<?php echo $id; ?>]' id='updateitemsku[<?php echo $style; ?>]' type='button' class='button' value='<?php esc_attr_e( 'Update' ); ?>' onclick="if( jQuery('#post_ID').val() < 0 ) return; itemSku.post('updateitemsku', <?php echo $id; ?>);" />
...
//usces_log('condition : '.print_r($condition,true), 'acting_transaction.log');
	...
	$materials = compact( 'total_items_price', 'shipping_charge', 'discount', 'cod_fee', 'use_point' );
