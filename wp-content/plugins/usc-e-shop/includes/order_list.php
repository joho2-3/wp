...
<?php endforeach; ?>
	...
	<table id="dl_list_table">
		...
		<td><input type="button" id="settlementlog" class="searchbutton" value="<?php _e('Settlement previous log list', 'usces'); ?>" /></td>
		<?php endif; ?>
		<?php if( !empty($settlement_notice) ) : ?>
		<td><input type="button" id="settlement_errorlog" class="searchbutton" value="<?php _e('Settlement error log list', 'usces'); ?>" /></td>
		<?php endif; ?>
		</tr>
	</table>
