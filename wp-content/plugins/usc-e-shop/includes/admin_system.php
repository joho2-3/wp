...
<table class="form_table">
	<tr height="35">
		...
		<td width="300">&nbsp;</td>
	    <td><div id="ex_use_ssl" class="explanation"><?php _e('Please decide whether you use SSL.', 'usces'); ?><br /><?php _e('However, if you want to SSL the entire site, please uncheck.', 'usces'); ?></div></td>
	</tr>
</table>
<table class="form_table">
	<tr height="35">
...
<table class="form_table">
	<tr height="30">
		...
		<td><div id="ex_settlement_backup" class="explanation"><?php _e('When the credit card settlement is chosen, save the purchase information in log before settlement. Create the order data from log.', 'usces'); ?></div></td>
	</tr>
</table>
</div>
</div><!--postbox-->
