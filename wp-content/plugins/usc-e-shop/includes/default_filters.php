...
add_filter('usces_filter_delivery_check', 'usces_filter_delivery_secure_check', 15);
...
if( isset($usces->options['acting_settings']['zeus']['card_activate']) && $usces->options['acting_settings']['zeus']['card_activate'] == 'on' ) {
