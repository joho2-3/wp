...
<div id="uscestabs" class="usces_settlement" style="display:none;">
	...
	<ul>
		<li><a href="#uscestabs_settlement_top"><?php _e('クレジット決済会社選択','usces'); ?></a></li>
	<?php if( in_array( 'zeus', (array)$settlement_selected ) ): ?>
		<li><a href="#uscestabs_zeus"><?php _e('ZEUS Japanese Settlement','usces'); ?></a></li>
	<?php endif; ?>
	<?php if( in_array( 'remise', (array)$settlement_selected ) ): ?>
	...
	<?php endif; ?>
	<?php if( in_array( 'paypal_wpp', (array)$settlement_selected ) ): ?>
	...
	<?php endif; ?>
	<?php if( in_array( 'anotherlane', (array)$settlement_selected ) ): ?>
		<li><a href="#uscestabs_anotherlane">アナザーレーン</a></li>
	<?php endif; ?>
	<?php if( in_array( 'veritrans', (array)$settlement_selected ) ): ?>
		<li><a href="#uscestabs_veritrans">ベリトランス</a></li>
	<?php endif; ?>
	<?php if( in_array( 'paygent', (array)$settlement_selected ) ): ?>
	...
	<form action="" method="post" id="settlement_top_form">
		<div class="settlement-left">
			<h2><?php _e('利用できるクレジット決済代行会社', 'usces'); ?></h2>
			<div class="settlement-description">
				<p class="description"><?php _e('利用したいクレジット決済代行会社を右側にドラッグしてください。<br />ドラッグ後は必ず「クレジット決済会社を更新する」ボタンをクリックしてください。', 'usces'); ?></p>
			</div>
		...
		<div class="settlement-right">
			<div class="settlement-selected-header">
				<?php _e('利用中のクレジット決済代行会社', 'usces'); ?>
			</div>
			...
			<div class="settlement-selected-footer">
				...
				<input name="usces_option_update" type="submit" class="button button-primary" value="クレジット決済会社を更新する" />
...
-->				<td><input name="card_jb" type="radio" id="card_jb_remise_2" value="AUTH"<?php if( isset($opts['remise']['card_jb']) && $opts['remise']['card_jb'] == 'AUTH' ) echo ' checked'; ?> /></td><td><label for="card_jb_remise_2">仮売上処理</label></td>
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="ルミーズの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
...
-->
	...
	<div class="settle_exp">
		...
		<a href="https://www.paypal.jp/jp/lp/aboutpaypal/" target="_blank"><?php _e('For the details on PayPal Express Checkout, click here >>', 'usces'); ?></a>
...
-->
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="テレコムクレジットの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
...
<!--		<table class="settle_table">
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="みずほファクターの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
	...
	<form action="" method="post" name="anotherlane_form" id="anotherlane_form">
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="アナザーレーンの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
	...
	<form action="" method="post" name="veritrans_form" id="veritrans_form">
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="ベリトランスの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
	...
	<form action="" method="post" name="paygent_form" id="paygent_form">
		...
		<input name="usces_option_update" type="submit" class="button button-primary" value="ペイジェントの設定を更新する" />
		<?php wp_nonce_field( 'admin_settlement', 'wc_nonce' ); ?>
	</form>
	<div class="settle_exp">
