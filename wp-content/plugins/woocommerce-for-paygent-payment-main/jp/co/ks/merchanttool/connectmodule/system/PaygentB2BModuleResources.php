...
//	define("PaygentB2BModuleResources__PROPERTIES_FILE_NAME", WC_PAYGENT_PLUGIN_PATH."/modenv_properties.php");
 ...
 class PaygentB2BModuleResources {
	...
	function readProperties() {
		...
		//Paygent side URL
		if($paygent_testmode == 1 or isset($_POST['check-test'])){
		...
		if(isset($_POST['check-test'])){
			$ca_file_path = WP_CONTENT_DIR.'/plugins/woocommerce-for-paygent-payment-main'.'/includes/gateways/paygent/asset/curl-ca-test-bundle.crt';
		}else{
			$ca_file_path = WP_CONTENT_DIR.'/uploads/wc-paygent/curl-ca-bundle.crt';
		}
		//
		if(isset($_POST['check-test'])){
			$client_file_path = WP_CONTENT_DIR.'/plugins/woocommerce-for-paygent-payment-main'.'/includes/gateways/paygent/asset/Mdev-20130909_client_cert.pem';
		}elseif($paygent_testmode == 1){
			$client_file_path = WP_CONTENT_DIR.'/uploads/wc-paygent/test_client_cert.pem';
		}else{
			$client_file_path = WP_CONTENT_DIR.'/uploads/wc-paygent/client_cert.pem';
		}
		...
		$prop = array(
			...
			'paygentB2Bmodule.url.01' => $paygent_url.'n/atm/request',
			'paygentB2Bmodule.url.02' => $paygent_url.'n/card/request',
			'paygentB2Bmodule.url.11' => $paygent_url.'n/card/request',
			'paygentB2Bmodule.url.18' => $paygent_url.'n/card/request',
			'paygentB2Bmodule.url.19' => $paygent_url.'n/card/request',
			'paygentB2Bmodule.url.03' => $paygent_url.'n/conveni/request',
			'paygentB2Bmodule.url.04' => $paygent_url.'n/conveni/request_print',
			'paygentB2Bmodule.url.05' => $paygent_url.'n/bank/request',
			'paygentB2Bmodule.url.06' => $paygent_url.'n/bank/requestasp',
			'paygentB2Bmodule.url.07' => $paygent_url.'n/virtualaccount/request',
			'paygentB2Bmodule.url.09' => $paygent_url.'n/ref/request',
			'paygentB2Bmodule.url.091' => $paygent_url.'n/ref/paynotice',
			'paygentB2Bmodule.url.093' => $paygent_url.'n/ref/runnotice',
			'paygentB2Bmodule.url.094' => $paygent_url.'n/ref/paymentref',
			'paygentB2Bmodule.url.10' => $paygent_url.'n/c/request',
			'paygentB2Bmodule.url.12' => $paygent_url.'n/c/request',
			'paygentB2Bmodule.url.20' => $paygent_url.'n/o/requestdata',
			'paygentB2Bmodule.url.15' => $paygent_url.'n/emoney/request',
			'paygentB2Bmodule.url.13' => $paygent_url.'n/paypal/request',
