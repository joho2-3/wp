...
function customizer_library_freestore_options() {
    ...
    $options['freestore-header-remove-add'] = array(
        ...
        'section' => $section,
        'type'    => 'checkbox',
        'description' => __( 'Remove the address from the header', 'freestore' ),
        'default' => 0,
    );
    $options['freestore-header-remove-no'] = array(
        ...
        'section' => $section,
        'type'    => 'checkbox',
        'description' => __( 'Remove the phone number from the header', 'freestore' ),
        'default' => 0,
    );
    ...
    if ( freestore_is_woocommerce_activated() ) :
        $options['freestore-header-remove-cart'] = array(
            ...
            'section' => $section,
            'type'    => 'checkbox',
        'description' => __( 'Remove the WooCommerce cart from the header', 'freestore' ),
            'default' => 0,
        );
    endif;
    ...
    $choices = array(
        ...
        'blog-post-right-layout' => 'Right Aligned Layout',
        'blog-post-alt-layout' => 'Alternate Layout',
