<?php
/**
 * Plugin Name: Prime Strategy Page Navi
...
$saitama_page_navi = new saitama_page_navi();

if ( ! function_exists( 'page_navi' ) ) {
	function page_navi( $args = '' ) {
		global $saitama_page_navi;
		return $saitama_page_navi->page_navi( $args );
	}
}