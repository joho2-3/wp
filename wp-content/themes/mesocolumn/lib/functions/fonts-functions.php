...
function wp_google_webfonts_family_list(){
$fontlist = wp_get_google_webfonts();
return $fontlist;
}
//add_action('wp_head', 'wp_google_webfonts_family_list');
...
$safe_font = array("Arial","Arial Black","Verdana","Tahoma","Trebuchet MS","Times New Roman","Helvetica Neue",
"Helvetica","Lucida Grande","Courier New","Lucida Console","Impact","Georgia","Palatino Linotype");
$http = (!empty($_SERVER['HTTPS'])) ? "https" : "http";
$un_bodytype = get_theme_mod('body_font');
$un_headtype = get_theme_mod('headline_font');
$un_navtype = get_theme_mod('navigation_font');
$bodytype = str_replace(' ' , '+', get_theme_mod('body_font'));
$headtype = str_replace(' ' , '+', get_theme_mod('headline_font'));
$navtype = str_replace(' ' , '+', get_theme_mod('navigation_font'));
$font_var = '100,200,300,400,500,600,700,800,900,100italic,200italic,300italic,400italic,500italic,600italic,700italic,800italic,900italic';
...
<?php }
add_action('wp_enqueue_scripts', 'dez_custom_google_font');
